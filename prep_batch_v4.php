...
<?php
    ...
    if (!is_dir($dir)) {
        ...
        if ($answer === "1") {
            $end_array = dirToArray($print_array, $dir, $other_files_folder, $directory_name, $arr_length, $beg, $end, $answer, $flag);
    ...
    function dirToArray(&$print_array, $dir, $other_files_folder, $directory_name, $arr_length, $beg, $end, $answer, $flag) {
        $cdir = scandir($dir);
        $counter = 0;
        $next_dir = " ";
                ...
                if (is_dir($dir . DIRECTORY_SEPARATOR . $value)) {
                    ...
                    if ($answer === "2") {
                        ...
                        if (strcmp($beg, $check_range_dir) === 0) {
                            ...
                            $flag = true;
                            $counter = 0;
                            dirToArray($print_array ,$dir . DIRECTORY_SEPARATOR . $value, $other_files_folder, $directory_name, $arr_length, $beg, $end, $answer, $flag);
                    ...
                    if ($val_exten === "tif" | $val_exten === "tiff") {
                        ...
                        $dir_parts = explode("/", $directoryname);
                        $arr_sub_dir_length = count($dir_parts);
                        
                        if ($arr_length === $arr_sub_dir_length) {
                            ...
                            array_push($print_array, $directoryname, "The directory already exists" );
                        }
